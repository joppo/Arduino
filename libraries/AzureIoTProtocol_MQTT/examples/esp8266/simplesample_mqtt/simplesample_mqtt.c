...
static const char* connectionString = "HostName=SmolyanskaHub.azure-devices.net;DeviceId=1A-SM-PWM-01C;SharedAccessKey=HfBklidgkBQ+eyQ/gCP7PSOgUZ/x5VPECUCcaw3npog=";
